...
export const GET: APIRoute = async () => {
  ...
  const staticPages = [
    ...
    { url: '/category/discovery', changefreq: 'weekly', priority: '0.8' },
    { url: '/category/making', changefreq: 'weekly', priority: '0.8' },
    { url: '/category/jeju', changefreq: 'weekly', priority: '0.8' },
